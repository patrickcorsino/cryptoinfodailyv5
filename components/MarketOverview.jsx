export default function MarketOverview({ stats }) {
  ...
  return (
    <div className="card-lux card-inner p-4 mb-6">
      <h2 className="text-lg font-bold mb-3 gold-text">Market Stats</h2>
      <div className="flex flex-wrap gap-4">
        ...
        <div>
          <span className="text-xs text-muted">BTC Dominance</span>
          <div className="font-bold text-marketData text-lg">{stats.market_cap_percentage?.btc?.toFixed(1) || "-"}%</div>
        </div>
        <div>
          <span className="text-xs text-muted">Active Coins</span>
